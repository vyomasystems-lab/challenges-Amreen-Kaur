...
def run_test1(dut):
    ...
    # input transaction
    for z in range(1): # taking random inputs from 0x00000000 to 0x0000ffff 

        input1 = random.randint(0, 65535)
        input2 = random.randint(0, 65535)

    mav_putvalue_src1 = input1
    mav_putvalue_src2 = input2
    mav_putvalue_src3 = 0x0
    print("input1 = {A} , input2 = {B}".format(A=hex(mav_putvalue_src1),B=hex(mav_putvalue_src2)))
    instruction =0x40007033
   
    
    print("The instruction executed is = {K}".format(K = bin(instruction)))
    mav_putvalue_instr = instruction
...
def run_test2(dut):
    ...
    mav_putvalue_src3 = 0x0
    print("input1 = {A} , input2 = {B}".format(A=hex(mav_putvalue_src1),B=hex(mav_putvalue_src2)))
    instructions =[0x40006033,0x40004033,0x20001033,0x20005033,0x60001033,0x60005033,
    ...
    0x6A005013,0x4005013,0x48007033]
